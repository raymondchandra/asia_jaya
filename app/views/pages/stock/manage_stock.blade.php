					...
					<tbody>
						...
						@if($products != null)
							...
							<tr> 
								...
								<td>
									<span class="" id="" style="line-height: 30px;" data-modal="{{$prodList->stock_shop}}">{{$prodList->stock_shop}}</span>
									<input type="text" id="" class="f_excel_xinput form-control input-sm hidden" style=""/>
								</td>
								<td>
									<span class="" id="" style="line-height: 30px;" data-modal="{{$prodList->stock_storage}}">{{$prodList->stock_storage}}</span>
									<input type="text" id="" class="f_excel_xinput form-control input-sm hidden" style=""/>
								</td>
								<td>
									{{$prodList->deleted}}
